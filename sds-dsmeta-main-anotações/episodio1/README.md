...
- Nodejs 16 e Yarn (vídeo: https://youtu.be/x5tgFTS-CYA )
    precisa instalar o Yarn após o node utilizando o npm
- STS para Eclipse Windows (vídeo: https://youtu.be/TGQ0K9QsX88 ) 
- VS Code
  - `IntelliCode`
  - `ESLint`
  - `JSX HTML <tags/>`
...
```
funcionou no prompt de comando

**DÚVIDAS**: veja o canal `#duvidas-frequentes` no Discord do evento

## Passo: criar projeto Spring Boot

- Criar projeto Spring Boot, utilizando a versão 2.7.x no `Spring Initializr` com as seguintes dependências:
  - Web
  - JPA
  - H2
  - Security
